...
var AppChart = (function () {
    function AppChart(apiService) {
        this.apiService = apiService;
        this.valueAt = 0;
        this.chartData = new Array();
    }
    AppChart.prototype.onMousemove = function (event) {
        if (this.mouseDown) {
    ...
    AppChart.prototype.onMouseup = function () {
        this.mouseDown = false;
    };
    AppChart.prototype.onMousedown = function (event) {
        this.mouseDown = true;
    };
    ...
    AppChart.prototype.getPointData = function (context) {
        var _this = this;
        if (!context)
            return;
    ...
    AppChart.prototype.scalePointsToArea = function (x, y) {
        var w = 150;
        var h = 90;
        var minX = 67;
        var minY = 33;
    ...
    AppChart.prototype.scaleAreaToPoints = function (x, y) {
        var w = 150;
        var h = 90;
        var minX = 67;
        var minY = 33;
    ...
    AppChart.prototype.getRgbFromValue = function (value) {
        if (value < 2) {
