...
var PageRegistration = (function () {
    function PageRegistration(userService, router) {
        this.userService = userService;
        this.router = router;
        this.submitted = false;
    }
    PageRegistration.prototype.ngOnInit = function () {
    };
    PageRegistration.prototype.registerUser = function (_a) {
        var _this = this;
